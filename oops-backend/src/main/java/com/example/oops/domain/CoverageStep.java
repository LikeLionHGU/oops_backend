...
public enum CoverageStep {
    ...
    /**
     * 화면 글자의 표현 검토. 현재는 꺼져 있어 NOT_ENABLED 로 보고된다.
     *
     * 화면 글자를 아예 안 본다는 뜻이 아니다.
     * 화면에 적힌 이름·연도·숫자는 FACT_ENTITY 가 확인하고 있다.
     * 여기서 하려던 건 화면 자막의 표현(조롱·비하 등) 검토인데,
     * 그 결과가 "발언" 후보로 나가는 문제가 있어 잠시 뺐다.
     */
    SCREEN_TEXT_REVIEW("화면 글자 검토"),

    /** 발언과 화면 글자 양쪽의 이름·연도·숫자를 자료와 대조한다 */
